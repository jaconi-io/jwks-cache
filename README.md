...
When enabling Kubernetes persistence, make sure that the service account used to run jwks-cache is allowed to create,
read, and update the configured ConfigMap in the configured namespace.
